document.write(`
<!--Sección de Descarga-->
</p><div class="download-container">
    <!--Header-->
        ...
        <div class="season-info">
            ...
            <div class="season-specs">
                <div class="season-spec">
                    ...
                    <div class="spec-value">Latino EAC3 5.1</div><div class="spec-value">Ingles EAC3 JOC 5.1</div></div><div class="season-spec"><div class="spec-label">FORMATO</div>
                    <div class="spec-value">MKV</div>
                </div>
                <div class="season-spec">
                    <div class="spec-label">PESO TEMPORADA</div>
                    <div class="spec-value">12.2 GB</div>
                </div>
                <div class="season-spec">
        ...
        <div class="episodes-grid">
            <div class="episode-card">
                ...
                <div class="episode-specs">
                    <div class="episode-spec">
                        ...
                        <div class="episode-spec-value">3.13 GB</div>
                    </div>
                    <div class="episode-spec">
                        <div class="episode-spec-label">DURACIÓN TOTAL</div>
                        <div class="episode-spec-value">~100 min
                      </div>
                    </div>
                </div>
                <a class="download-button" href="https://tpi.li/dU53R1" target="_blank">
                    <span>📥</span>
                    <span>DESCARGAR</span>
                </a>
            </div>
            ...
            <div class="episode-card">
                ...
                <div class="episode-specs">
                    <div class="episode-spec">
                        <div class="episode-spec-label">PESO</div>
                        <div class="episode-spec-value">2.80 GB</div>
                    </div>
                    <div class="episode-spec">
                        <div class="episode-spec-label">DURACIÓN TOTAL</div>
                        <div class="episode-spec-value">~94 min</div>
                    </div>
                </div>
                <a class="download-button" href="https://tpi.li/dU53R3" target="_blank">
                    <span>📥</span>
                    <span>DESCARGAR</span>
                </a>
            </div>
            ...
            <div class="episode-card">
                ...
                <div class="episode-specs">
                    <div class="episode-spec">
                        <div class="episode-spec-label">PESO&nbsp;</div>
                        <div class="episode-spec-value">2.68 GB</div>
                    </div>
                    <div class="episode-spec">
                        <div class="episode-spec-label">DURACIÓN TOTAL</div>
                        <div class="episode-spec-value">~91 min</div>
                    </div>
                </div>
                <a class="download-button" href="https://tpi.li/dUS3R5" target="_blank">
                    <span>📥</span>
                    <span>DESCARGAR</span>
                </a>
            </div>
           ...
           <div class="episode-card">
                ...
                <div class="episode-specs">
                    <div class="episode-spec">
                        <div class="episode-spec-label">PESO</div>
                        <div class="episode-spec-value">3.58 GB</div>
                    </div>
                    <div class="episode-spec">
                        <div class="episode-spec-label">DURACIÓN TOTAL</div>
                        <div class="episode-spec-value">~104 min</div>
                    </div>
                </div>
                <a class="download-button" href="https://tpi.li/dUS3R7" target="_blank">
                    <span>📥</span>
                    <span>DESCARGAR</span>
                </a>
            </div>
